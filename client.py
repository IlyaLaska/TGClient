...
#TODO: finish /tt
#TODO: URGENT - deal with incorrect group input
#TODO: what if there is no teacher?
...
@client.on(events.NewMessage(outgoing=True, pattern='(F|A)$'))
async def test(e):
  # print(e.message)
  # await client.edit_message(e.message, 'FFFFFF')
  print(e)
...
async def handler(event):
  ...
  print(event)
  print('--------------------------------------')
  a = await client.get_entity(event.from_id)
  print(a)
  # await event.reply('Ага!')
...
#   # AS = client.get_entity('+380992328237')
#   # print(AS)
#   # chats10 = client.get_dialogs(limit=10)
#   # for chat in chats10:
#     # print(chat)
#     # print(type(chat))
#     # if chat.name = 'Alexander Solosich' : print('FOUND')


#   # client.send_message(AS, 'В принципе можешь и не делать')
#   # client.send_message(AS, 'Мои длинные ручки и так до тебя дотянутся')
#   # me = client.get_me()
#   # print(me.stringify())
